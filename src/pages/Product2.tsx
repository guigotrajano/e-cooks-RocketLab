...
<>
    ...
    <div className='flex flex-col text-end'>
        ...
        <div className=''>
            <h1 className='absolute right-40 top-15 text-3xl font-coustard font-medium text-gray-800'>As 50 Melhores Massas das <br/> Cantinas Italianas</h1>
            ...
            <p className='absolute text-left pl-230 pr-30 top-45 text-sm font-inter text-gray-800 leading-relaxed'>
                {productDetails.name}! Viaje para o coração da Itália sem sair da sua cozinha com As 50 Melhores Massas das Cantinas Italianas! Uma coletânea irresistível de receitas tradicionais que encantam gerações – de uma autêntica lasanha bolonhesa a um espaguete ao vôngole de fazer suspirar. Este e-book revela segredos das verdadeiras cantinas familiares italianas, com massas frescas, molhos encorpados e aquele toque caseiro que só uma nonna saberia fazer. Ideal para surpreender na próxima refeição ou impressionar em um jantar especial.
            </p>
